...
CIRCUIT_BREAKER_THRESHOLD="${CIRCUIT_BREAKER_THRESHOLD:-0.7}"  # Stop if reward < 0.7
...
MIN_REWARD=0.6  # Absolute minimum before abort
WARNING_REWARD=0.8  # Warning threshold
