...
Use 'bd' for task tracking and state persistence
ROAM state managed via Beads pattern for persistence

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **agentic-flow** (153624 symbols, 354440 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
