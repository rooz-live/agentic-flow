...
export class SwarmLearningOptimizer {
    ...
    async getOptimization(taskDescription, taskComplexity, estimatedAgentCount) {
        ...
        const similarPatterns = await this.reasoningBank.retrievePatterns(taskDescription, {
            k: 10,
            minReward: 0.7,
            onlySuccesses: true
        });
    ...
    async getOptimizationStats() {
        const allPatterns = await this.reasoningBank.retrievePatterns(this.NAMESPACE, {
            k: 1000,
            onlySuccesses: true
        });
        const stats = {
