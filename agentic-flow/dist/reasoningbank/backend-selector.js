...
export function getBackendInfo() {
    ...
    return {
        backend,
        environment: typeof globalThis.window !== 'undefined' ? 'browser' : 'nodejs',
        features: {
...
export function validateEnvironment() {
    ...
    if (backend === 'wasm' && typeof globalThis.window !== 'undefined' && !hasIndexedDB()) {
    ...
    if (backend === 'wasm' && typeof globalThis.window === 'undefined') {
