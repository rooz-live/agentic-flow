...
export interface SkillTemplate {
  name: string;
  description: string;
  category: 'agentdb' | 'orchestration' | 'integration';
 ...
 */
export function initSkillsDirectories(location: 'personal' | 'project' | 'both' = 'both'): void {
 ...
 */
function findSkills(dir: string): Array<{ name: string; description: string; path: string }> {
 ...
 */
async function handleSkillsInit(args: string[]): Promise<void> {
  const location = (args[0] as 'personal' | 'project' | 'both') || 'both';
 ...
 */
async function handleSkillBuilderInit(args: string[]): Promise<void> {
  const location = (args[0] as 'personal' | 'project' | 'both') || 'project';
 ...
 */
function createSkillBuilderFromTemplate(builderDir: string): void {
 ...
 */
async function handleSkillsCreate(args: string[]): Promise<void> {
  console.log('');
 ...
 */
function createAgentDBVectorSearchSkill(): string {
  return `---
 ...
 */
function createAgentDBMemoryPatternsSkill(): string {
  return `---
 ...
 */
function createSwarmOrchestrationSkill(): string {
  return `---
 ...
 */
function createReasoningBankSkill(): string {
  return `---
