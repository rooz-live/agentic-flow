 ...
 */
export function displayUpdateMessage(info: UpdateInfo): void {
 ...
 */
export function displayCompactUpdate(currentVersion: string, latestVersion: string): void {
  console.log('');
 ...
 */
export function displayV170Update(): void {
 ...
 */
export function displayPhilosophyBanner(): void {
  console.log('\n');
  console.log(chalk.cyan('═══════════════════════════════════════════════════════════════'));
  console.log('');
 ...
 */
export function displayGraphIntelligence(): void {
  console.log('\n');
 ...
 */
export function displayStartupUpdateCheck(currentVersion: string, latestVersion: string): void {
