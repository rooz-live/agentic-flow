...
export type IrisMiddleware = (command: IrisCommand, next: () => Promise<IrisOutput>) => Promise<IrisOutput>;
...
export declare const DEFAULT_IRIS_RETRY_CONFIG: IrisRetryConfig;
export declare const DEFAULT_IRIS_CIRCUIT_BREAKER_CONFIG: IrisCircuitBreakerConfig;
export declare const DEFAULT_IRIS_PERFORMANCE_CONFIG: IrisPerformanceConfig;
export declare const DEFAULT_IRIS_VALIDATION_CONFIG: IrisValidationConfig;
export declare const DEFAULT_IRIS_CONCURRENCY_CONFIG: IrisConcurrencyConfig;
export declare const DEFAULT_IRIS_BRIDGE_CONFIG: IrisBridgeConfig;
//# sourceMappingURL=iris_types.d.ts.map