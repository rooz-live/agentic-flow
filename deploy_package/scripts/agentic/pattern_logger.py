...
class PatternLogger:
    ...
    def log(self, pattern_name, data, mode_override=None, gate=None, behavioral_type="observability",
        ...
        entry = {
            ...
            "metrics": {k: v for k, v in data.items() if k not in ["iteration", "framework", "scheduler", "tags", "reason", "action", "action_completed", "duration_ms"]},
            "data": {
                ...
                "duration_measured": data.get("duration_ms") is not None,
                "duration_ms": data.get("duration_ms") if data.get("duration_ms") is not None else 1,
    ...
    def log_safe_degrade(self, trigger, action, details=None, iteration=0):
    ...
    def log_depth_ladder(self, old_depth, new_depth, reason, mutation=False, iteration=0):
    ...
    def log_depth_oscillation(self, depth_changes, oscillation_count, current_depth, recommendation, iteration=0):
        ...
        self.log("depth_oscillation", {
            ...
            "tags": ["depth", "oscillation", "stability"]
    ...
    def log_circle_risk_focus(self, target_circle, extra_iterations=0, roam_reduction=0, iteration=0):
        ...
        self.log("circle_risk_focus", {
            ...
            "iteration": iteration,
            "action": "focus",
            "tags": [f"pattern:circle-risk-focus"]
        }, gate="focus", behavioral_type="advisory")

    def log_iteration_budget(self, requested, enforced, saved=0, autocommit_runs=0, iteration=0):
    ...
    def log_observability_first(self, metrics_written, missing_signals=None, suggestion_made=None, iteration=0):
    ...
    def log_flow_metrics(self, cycle_time, lead_time, throughput, wip_count, flow_efficiency, velocity=0, iteration=0):
        ...
        self.log("flow_metrics", {
            ...
            "iteration": iteration,
            "action": "measure",
            "tags": ["flow", "metrics", "productivity"]
