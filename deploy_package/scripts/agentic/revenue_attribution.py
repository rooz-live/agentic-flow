...
CIRCLE_REVENUE_IMPACT = {
    'innovator': 5000,      # Highest - new product features, competitive differentiation
    'analyst': 3500,        # High - strategic insights, data-driven decisions
    'orchestrator': 2500,   # Medium - coordination, flow optimization
    'assessor': 2000,       # Medium - quality assurance, risk mitigation
    'intuitive': 1000,      # Lower - exploratory work, strategic framing
