...
export class DataSharingControls {
    policies;
    patientPolicies; // patientId -> policyId
    constructor() {
     ...
     */
    isDataSharingAllowed(patientId, providerId, dataCategory) {
     ...
     */
    checkRestrictionViolation(restriction, context) {
     ...
     */
    checkTimeRestriction(rules, timestamp) {
     ...
     */
    async addAllowedProvider(patientId, providerId) {
        const policyId = this.patientPolicies.get(patientId);
        if (!policyId) {
            return false;
        }
     ...
     */
    async removeAllowedProvider(patientId, providerId) {
        const policyId = this.patientPolicies.get(patientId);
        if (!policyId) {
            return false;
        }
     ...
     */
    async addDataCategory(patientId, category) {
        const policyId = this.patientPolicies.get(patientId);
        if (!policyId) {
            return false;
        }
     ...
     */
    async addRestriction(patientId, restriction) {
        const policyId = this.patientPolicies.get(patientId);
        if (!policyId) {
            return false;
        }
     ...
     */
    async setPolicyActiveStatus(patientId, active) {
        const policyId = this.patientPolicies.get(patientId);
        if (!policyId) {
            return false;
        }
...
//# sourceMappingURL=data-sharing-controls.js.map