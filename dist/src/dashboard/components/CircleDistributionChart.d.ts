...
export declare function CircleDistributionChart({ circleMetrics, loading }: CircleDistributionChartProps): any;
export {};
//# sourceMappingURL=CircleDistributionChart.d.ts.map