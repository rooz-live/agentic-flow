...
export default function HierarchicalSwarmVisualization({ apiEndpoint, refreshInterval, showLayers }: SwarmVisualizationProps): any;
export declare function createProductionVisualization(deployment: 'starlingx' | 'cpanel' | 'localhost'): any;
export {};
