...
export declare function OverviewDashboard({ metrics, anomalies, executionStatuses, circleMetrics, loading }: OverviewDashboardProps): import("react/jsx-runtime").JSX.Element;
export {};
