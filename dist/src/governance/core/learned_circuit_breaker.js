...
export class LearnedCircuitBreaker {
    ...
    adaptThresholds() {
        ...
        const stdErrorRate = Math.sqrt(errorRates.reduce((sum, r) => sum + Math.pow(r - avgErrorRate, 2), 0) / errorRates.length);
        ...
        const stdP95 = Math.sqrt(p95Latencies.reduce((sum, l) => sum + Math.pow(l - avgP95, 2), 0) / p95Latencies.length);
...
//# sourceMappingURL=learned_circuit_breaker.js.map