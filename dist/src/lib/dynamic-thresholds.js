 ...
 */
function execThresholdFunction(funcName, ...args) {
    try {
 ...
 * Now: ROAM 2.0/10
 */
export function getCircuitBreakerThreshold(circle, ceremony) {
 ...
 * Now: ROAM 2.5/10
 */
export function getDegradationThreshold(circle, ceremony, currentReward) {
    return execThresholdFunction('calculate_degradation_threshold', circle, ceremony, currentReward.toString());
}
/**
 ...
 * Now: ROAM 3.0/10
 */
export function getCascadeThreshold(circle, ceremony) {
 ...
 * Now: ROAM 2.0/10
 */
export function getDivergenceRate(circle, ceremony) {
 ...
 * Now: ROAM 3.0/10
 */
export function getCheckFrequency(circle, ceremony) {
 ...
 * ROAM: 2.5/10
 */
export function detectRegimeShift(circle, ceremony) {
    try {
 ...
 * Now: ROAM 2.5/10
 */
export function getQuantileThreshold(circle, ceremony, quantile = 0.05) {
    return execThresholdFunction('get_quantile_threshold', circle, ceremony, quantile.toString());
}
