 ...
 */
import { QueryStatus, QueryPriority } from './types';
export class PatientQueue {
     ...
     */
    async assignToProvider(queryId, providerId) {
        const query = this.queue.get(queryId);
        if (!query) {
     ...
     */
    getQueriesForProvider(providerId) {
...
//# sourceMappingURL=patient-queue.js.map