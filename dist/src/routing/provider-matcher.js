...
export class ProviderMatcher {
     ...
     */
    async findMatches(query, availableProviders, topN = 5) {
        const matches = [];
     ...
     */
    calculateMatchScore(query, provider) {
        let score = 0;
     ...
     */
    matchSpecialization(query, specializations) {
...
//# sourceMappingURL=provider-matcher.js.map