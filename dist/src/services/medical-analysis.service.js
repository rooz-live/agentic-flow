...
export class MedicalAnalysisService {
     ...
     */
    async generateDiagnosis(request) {
     ...
     */
    async generateRecommendations(request, diagnoses) {
     ...
     */
    generateDifferentials(primaryCondition, symptoms) {
     ...
     */
    inferConditionFromSymptoms(symptoms) {
...
//# sourceMappingURL=medical-analysis.service.js.map