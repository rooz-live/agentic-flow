export class VerificationService {
    ...
    async checkMedicalAccuracy(analysis, diagnosis) {
    ...
    async checkCitationValidity(citations) {
    ...
    async checkLogicalConsistency(analysis, diagnosis) {
    ...
    async checkGuidelineCompliance(recommendations) {
    ...
    async checkHallucinationFree(analysis, citations) {
    ...
    async identifyIssues(checks, data) {
        const issues = [];
