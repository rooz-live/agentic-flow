...
export function calculateSlopScore(content, config = DEFAULT_CONFIG) {
    ...
    const score = ((substantiveRatio >= config.substantive_content_ratio ? substantiveRatio : substantiveRatio * 0.5) * weights.substantive +
...
export function blockMergeOnSlop(prDiff, config) {
...
//# sourceMappingURL=slop_detection.js.map