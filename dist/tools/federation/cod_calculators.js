 ...
 */
export function calculateHPCCOD(context) {
    const { queue_time_sec = 0, gpu_util_pct = 0, node_count = 1, p99_latency_ms = 0, throughput_samples_sec = 0, pattern, } = context;
 ...
 */
export function calculateMLCOD(context) {
    const { queue_time_sec = 0, gpu_util_pct = 0, node_count = 1, p99_latency_ms = 0, max_epochs = 0, early_stop_triggered = false, grad_explosions = 0, nan_batches = 0, pattern, } = context;
 ...
 * - Analysis delays
 */
export function calculateStatsCOD(context) {
    const { num_seeds = 0, num_datasets = 0, coverage_score = 0, pvalue_min = 0.05, pattern, } = context;
 ...
 */
export function calculateDeviceWebCOD(context) {
    const { cls_score = 0, lcp_ms = 0, fid_ms = 0, touch_targets_below_44px = 0, avg_response_time_ms = 0, pattern, } = context;
 ...
 */
export function calculateGeneralCOD(context) {
 ...
 */
export function calculateCOD(context) {
...
//# sourceMappingURL=cod_calculators.js.map