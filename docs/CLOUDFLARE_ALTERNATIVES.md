...
# Expose via ngrok v3 for Discord webhook
ngrok http 3000 --config=~/.ngrok2/ngrok.yml
# Or with reserved domain (paid plan):
...
# ngrok v3 with config (recommended)
ngrok http 3000 --config=~/.ngrok2/ngrok.yml

# Copy ngrok HTTPS URL → Discord Developer Portal
# General Information → Interactions Endpoint URL
# Paste: https://interface-tag-vote.ngrok.io/api/discord
