 ...
 */
function showProgress(current: number, total: number, message: string = 'Processing'): void {
 ...
 */
export function setupDatabaseCommands(program: Command): void {
  // Import command
  program
    ...
    .action(async (database: string, file: string, options: any) => {
  ...
  program
    ...
    .option('-v, --verbose', 'Verbose output', false)
    .action(async (database: string, embedding: string, options: any) => {
