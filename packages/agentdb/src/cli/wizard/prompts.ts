...
export async function promptMetadata(options: WizardOptions): Promise<MetadataConfig> {
...
export async function promptAlgorithm(template?: string): Promise<AlgorithmConfig> {
...
export async function promptReward(): Promise<RewardConfig> {
...
export async function promptStorage(pluginName: string): Promise<StorageConfig> {
  const answers = await inquirer.prompt([
    {
      type: 'input',
      name: 'path',
...
export async function promptTraining(algorithmType: string): Promise<TrainingConfig> {
...
export async function promptMonitoring(): Promise<MonitoringConfig | undefined> {
