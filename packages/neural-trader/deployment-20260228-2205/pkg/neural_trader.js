/* @ts-self-types="./neural_trader.d.ts" */
...
export class NeuralTrader {
     ...
     * @param {any} market_data
     * @returns {any}
     */
    analyze(market_data) {
        const ret = wasm.neuraltrader_analyze(this.__wbg_ptr, market_data);
        return ret;
    }
    /**
     ...
     * @param {any} position_data
     * @returns {any}
     */
    calculate_risk(position_data) {
        const ret = wasm.neuraltrader_calculate_risk(this.__wbg_ptr, position_data);
        return ret;
    }
    /**
     * @returns {any}
     */
    get_health() {
        const ret = wasm.neuraltrader_get_health(this.__wbg_ptr);
        return ret;
    }
    initialize() {
        wasm.neuraltrader_initialize(this.__wbg_ptr);
    }
    /**
...
if (Symbol.dispose) NeuralTrader.prototype[Symbol.dispose] = NeuralTrader.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('neural_trader_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
