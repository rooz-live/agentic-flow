# Portfolio Technical Analysis Report
**Generated**: 2025-12-19T00:57:49.515485Z  
**Analysis Mode**: DEGRADED  
**Tickers**: SOXL, SOXS

## ⚠️ Important Notice
This analysis is in **DEGRADED mode**. Live market data requires additional packages:
```bash
...
**Analysis Timestamp**: 2025-12-19T00:57:49.515875Z
...
**Data Source**: MANUAL - Check TradingView, Yahoo Finance, or broker platform
...
- **Volume Trend**: MANUAL_CHECK_REQUIRED
...
TBD - Check earnings calendar manually
...
- Max Risk: Max loss = spread width - credit received
- Max Reward: Max gain = credit received
- Use Case: Neutral to bullish, collect premium

**Bear Call Spread**:
- Structure: Sell OTM call + Buy further OTM call
- Max Risk: Max loss = spread width - credit received
- Max Reward: Max gain = credit received
- Use Case: Neutral to bearish, collect premium

**Iron Condor**:
- Structure: Bull put spread + Bear call spread
- Max Risk: Max loss = spread width - net credit
- Max Reward: Max gain = net credit received
- Use Case: Low volatility, range-bound

**Calendar Spread**:
- Structure: Sell near-term option + Buy longer-term option (same strike)
- Max Risk: Max loss = net debit paid
- Max Reward: Max gain = varies with time decay
- Use Case: Earnings volatility crush
...
**Rating Scale**: 1 (avoid) to 10 (high conviction)

**Assessment Factors**:
- **Technical Setup**: Check chart for support/resistance
