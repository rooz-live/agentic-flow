...
| **TDD** | 🟢 99% | 174 | 3 | 174 test file(s) found |
...
- ✅ [INFO] Test file follows naming convention: Correct: typescript-compilation.test.ts `tests/infrastructure/typescript-compilation.test.ts`
- ✅ [WARNING] Test assertion density ≥ 1.0 per test: 4.5 assertions/test (9 assertions, 2 tests) `tests/infrastructure/typescript-compilation.test.ts`
...
- ✅ [WARNING] Test assertion density ≥ 1.0 per test: 2.0 assertions/test (22 assertions, 11 tests) `tests/test_governance_admission.py`
...
- ✅ [WARNING] Test assertion density ≥ 1.0 per test: 3.7 assertions/test (11 assertions, 3 tests) `tests/test_k8s_conformance.py`
...
- ✅ [CRITICAL] Unit tests present: 2011 test functions found
- ✅ [WARNING] Integration tests present: 64 integration test file(s)
- ✅ [INFO] Total assertion count reasonable: 6294 total assertions across 174 files
...
|:------|:-----------------|
| **Observe** | Scanned 244 files across 4 layers |
| **Orient** | Health: PRD=93%, ADR=90%, DDD=97%, TDD=99% |
| **Decide** | Verdict: PASS at 97% |
| **Act** | 7 recommendations to implement |

---
*Generated by DDD/TDD/ADR Coherence Validator v1.0 | 2026-04-03 13:51:05*