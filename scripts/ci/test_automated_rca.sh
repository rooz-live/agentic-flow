...
GOVERNANCE_SCRIPT="$PROJECT_ROOT/investing/agentic-flow/scripts/policy/governance.py"
AF_SCRIPT="$PROJECT_ROOT/investing/agentic-flow/scripts/af"
AF_BACKUP="$PROJECT_ROOT/investing/agentic-flow/scripts/af.bak"
...
METRICS_LOG="$PROJECT_ROOT/investing/agentic-flow/.goalie/metrics_log.jsonl"
