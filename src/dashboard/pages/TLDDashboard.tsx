              ...
              {TLDs.map((tld) => (
                <button
                  ...
                  className={`
                    ...
                    ${activeTab === tld.domain ? 'bg-white/10 text-white shadow-sm' : 'hover:bg-white/5 text-sky-300 hover:text-slate-200'}
                  `}
                >
        ...
        <header className="h-20 border-b border-white/10 bg-white/5 backdrop-blur-md px-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button 
              ...
              className="p-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors border border-white/5 text-sky-300 hover:text-white"
            >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                { label: 'DGM Re-Render Syncs', value: telemetry?.elizaos_sync_state?.substring(0, 15) || '...', trend: 'ElizaOS Baseline', color: 'text-indigo-200' },
                ...
                <div key={i} className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors group">
                  <h3 className="text-sky-300 text-sm font-medium mb-2">{stat.label}</h3>
              ...
              <div className="bg-white/5 rounded-[22px] p-8 min-h-[400px] flex flex-col">
                <div className="flex justify-between items-center mb-8 pb-6 border-b border-white/5">
                  <div>
                    ...
                    <p className="text-sm text-sky-300 max-w-xl">
