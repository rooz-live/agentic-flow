...
export class PatternMetricsService {
  ...
  constructor(baseUrl: string = '/api', wsUrl: string = 'ws://localhost:8080') {
   ...
   */
  async fetchAnomalies(): Promise<AnomalyDetection[]> {
    try {
   ...
   */
  async fetchExecutionStatuses(): Promise<PatternExecutionStatus[]> {
    try {
   ...
   */
  async fetchCircleMetrics(): Promise<CircleMetrics[]> {
    try {
   ...
   */
  private async fetchLocalMetrics(): Promise<PatternMetric[]> {
    try {
      ...
      return lines
        ...
        .filter(Boolean) as PatternMetric[];
    } catch (error) {
   ...
   */
  private generateMockAnomalies(): AnomalyDetection[] {
    return [
      {
        id: '1',
        severity: 'high',
   ...
   */
  private generateMockExecutionStatuses(): PatternExecutionStatus[] {
    return [
      {
   ...
   */
  private generateMockCircleMetrics(): CircleMetrics[] {
    return [
      {
        name: 'orchestrator',
        totalPatterns: 342,
