...
export interface CircuitBreakerState {
  ...
  open_until?: string; // ISO timestamp when circuit can transition to HALF_OPEN
...
export function classifyProviderError(
  ...
  const baseEvidence: Partial<ProviderErrorEvidence> = {
  ...
  let errorType: ProviderErrorType = ProviderErrorType.UNKNOWN;
...
export function getDegradationStrategy(errorType: ProviderErrorType): DegradationStrategy {
  switch (errorType) {
