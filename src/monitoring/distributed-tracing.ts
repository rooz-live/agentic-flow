import { trace, context, SpanKind, SpanStatusCode, Attributes } from '@opentelemetry/api';
...
export class DistributedTracing {
  ...
  async withSpan<T>(options: SpanOptions, fn: (span: any) => Promise<T>): Promise<T> {
