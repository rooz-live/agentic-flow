 ...
 */
export async function getDaysSinceCommit(): Promise<number> {
  try {
 ...
 */
export async function getBuildFailureRate(): Promise<number> {
 ...
 */
export async function getTestExecutionFrequency(): Promise<number> {
 ...
 */
export async function getDocumentationDrift(): Promise<number> {
  try {
    const { execSync } = await import('child_process');
 ...
 */
export async function getCoveragePercent(): Promise<number> {
