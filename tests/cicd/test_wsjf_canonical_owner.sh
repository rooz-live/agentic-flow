...
AF_SHIM="$ROOT/scripts/wsjf/wsjf_calculator.py"
AF_REDIRECT="$ROOT/scripts/wsjf/_canonical_redirect.py"
AF_MARKER="$ROOT/scripts/wsjf/CANONICAL_OWNER"
...
test -f "$AF_MARKER" || { echo "FAIL: missing scripts/wsjf CANONICAL_OWNER marker"; exit 1; }
...
test -f "$AF_SHIM" || { echo "FAIL: missing scripts/wsjf wsjf_calculator shim"; exit 1; }
