...
exports.MultiDimensionalAnalytics = void 0;
const fs = require("fs");
const path = require("path");
const shared_utils_js_1 = require("./shared_utils.js");
const wsjf_calculator_js_1 = require("./wsjf_calculator.js");
class MultiDimensionalAnalytics {
    constructor(goalieDir) {
        this.goalieDir = goalieDir;
        this.wsjfCalculator = new wsjf_calculator_js_1.WSJFCalculator(goalieDir);
    }
    /**
     * Generate comprehensive multi-dimensional analytics
     */
    generateAnalytics(patterns_1, insights_1) {
        return __awaiter(this, arguments, void 0, function* (patterns, insights, timeWindow = 30 // days
        ) {
    ...
    analyzeCostDimension(wsjfResults) {
        ...
        const highCostThreshold = ((_a = sortedByCost[Math.floor(sortedByCost.length * 0.1)]) === null || _a === void 0 ? void 0 : _a.costOfDelay) || 0;
     ...
     */
    saveAnalyticsResults(analytics) {
    ...
    generateTrendAnalysis() {
        return __awaiter(this, void 0, void 0, function* () {
            const historicalData = yield this.loadHistoricalAnalytics();
     ...
     */
    executeAnalytics() {
        return __awaiter(this, arguments, void 0, function* (timeWindow = 30) {
            ...
            const patterns = yield (0, shared_utils_js_1.readJsonl)(patternsPath);
            const insights = yield (0, shared_utils_js_1.readJsonl)(insightsPath);
            // Generate comprehensive analytics
            const analytics = yield this.generateAnalytics(patterns, insights, timeWindow);
            // Save results
            yield this.saveAnalyticsResults(analytics);
            // Generate trend analysis
            const trendAnalysis = yield this.generateTrendAnalysis();
...
exports.MultiDimensionalAnalytics = MultiDimensionalAnalytics;
