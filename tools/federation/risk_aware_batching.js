...
exports.RiskAwareBatchingSystem = void 0;
const fs = require("fs");
const path = require("path");
const yaml = require("yaml");
class RiskAwareBatchingSystem {
     ...
     */
    createBatchingPlan(items, policyId, constraints) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (constraints === null || constraints === void 0 ? void 0 : constraints.maxItems) {
                finalItems = eligibleItems.slice(0, constraints.maxItems);
            }
            if (constraints === null || constraints === void 0 ? void 0 : constraints.maxDuration) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (planIndex !== -1) {
                        updatedPlans[planIndex] = Object.assign(Object.assign({}, updatedPlans[planIndex]), { status: 'completed', itemsSuccessful: plan.items.length, actualDuration: plan.estimatedDuration, completedAt: new Date().toISOString() });
    ...
    analyzeBatchPerformance() {
        return __awaiter(this, arguments, void 0, function* (days = 30) {
            const history = yield this.getBatchHistory(days);
            if (history.length === 0) {
                return {
                    totalBatches: 0,
                    successRate: 0,
    ...
    generateOptimizationRecommendations() {
        return __awaiter(this, void 0, void 0, function* () {
            const performance = yield this.analyzeBatchPerformance();
...
exports.RiskAwareBatchingSystem = RiskAwareBatchingSystem;
