...
class WSJFCalculator {
    ...
    calculateWSJF(event, context) {
        ...
        return {
            ...
            category: (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category) || 'General',
    ...
    extractWSJFParameters(event, patternConfig, context) {
        ...
        const codThreshold = (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.cod_threshold) || 6;
        const category = (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category) || 'General';
    ...
    calculateUserBusinessValue(event, patternConfig, cod) {
        ...
        const categoryMultiplier = {
            ...
            'Device/Web': 0.8,
            'General': 1.0
        }[patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category] || 1.0;
    ...
    calculateTimeCriticality(event, patternConfig, cod) {
        ...
        const severity = (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.cod_threshold) || 6;
        const baseCriticality = Math.min((severity + cod) / 2, 20);
        // Boost for observability-required patterns
        if (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.observability_required) {
    ...
    calculateRiskReduction(event, patternConfig, cod) {
        ...
        if (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.code_fix_available) {
    ...
    calculateJobDuration(event, patternConfig) {
        ...
        const categoryComplexity = {
            ...
            'Device/Web': 5,
            'General': 4
        }[patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category] || 6;
        // Adjust based on whether code fix is available
        const fixAvailable = (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.code_fix_available) ? 0.7 : 1.0;
    ...
    calculateComplexityMultiplier(event, patternConfig) {
        ...
        const frameworks = (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.frameworks) || [];
        const schedulers = (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.schedulers) || [];
        let complexity = 1.0;
    ...
    assessTechnicalRisk(event, patternConfig) {
        ...
        if (((_a = patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.frameworks) === null || _a === void 0 ? void 0 : _a.length) > 2)
            risk += 2;
        if ((_b = patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.schedulers) === null || _b === void 0 ? void 0 : _b.includes('slurm'))
            risk += 1;
    ...
    assessDependencyRisk(event, patternConfig) {
        ...
        if ((patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category) === 'ML' || (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category) === 'HPC') {
            risk += 2;
        }
        // Higher risk for patterns with multiple schedulers
        if (((_a = patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.schedulers) === null || _a === void 0 ? void 0 : _a.length) > 1)
            risk += 1;
        return Math.min(risk, 10);
    }
    assessResourceRisk(event, patternConfig) {
        ...
        if ((patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category) === 'HPC')
            risk += 3;
        if ((patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.category) === 'ML')
            risk += 2;
        return Math.min(risk, 10);
    }
    ...
    generateTitle(event, patternConfig) {
        if (event.title)
            return event.title;
        if (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.name)
            return patternConfig.name;
        if (patternConfig === null || patternConfig === void 0 ? void 0 : patternConfig.description)
            return patternConfig.description;
        return `Pattern: ${event.pattern || 'unknown'}`;
    }
}
exports.WSJFCalculator = WSJFCalculator;
