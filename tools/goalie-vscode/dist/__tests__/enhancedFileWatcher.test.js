...
const mockVSCode = {
    ...
    window: {
        createOutputChannel: (name) => ({
            ...
            showInformationMessage: (msg, ...items) => console.log(`INFO: ${msg}`, items),
...
describe('EnhancedFileWatcher', () => {
    ...
    beforeEach(() => {
        ...
        enhancedFileWatcher = new enhancedFileWatcher_1.EnhancedFileWatcher(testDir, refreshCallbacks, {
    ...
    test('should handle file metadata caching', () => {
        ...
        expect(metadata === null || metadata === void 0 ? void 0 : metadata.path).toBe(testFile);
        expect(metadata === null || metadata === void 0 ? void 0 : metadata.size).toBeGreaterThan(0);
    });
    ...
    test('should handle multiple file patterns', () => {
        ...
        expect(yamlMetadata === null || yamlMetadata === void 0 ? void 0 : yamlMetadata.extension).toBe('.yaml');
        expect(jsonlMetadata === null || jsonlMetadata === void 0 ? void 0 : jsonlMetadata.extension).toBe('.jsonl');
    });
    test('should respect ignore patterns', () => {
        ...
        const enhancedWatcherWithIgnore = new enhancedFileWatcher_1.EnhancedFileWatcher(testDir, refreshCallbacks, {
            patterns: ['**/.goalie/*.{yaml,jsonl}'],
            ignorePatterns: ['**/*.tmp'],
            debounceDelay: 100,
            enableBatching: true,
...
describe('FileWatcherService', () => {
    ...
    beforeEach(() => {
        ...
        const goalieDir = path.join(testDir, '.goalie');
        fs.mkdirSync(goalieDir, { recursive: true });
        fileWatcherService = new fileWatcherService_1.FileWatcherService(testDir, {
            patterns: ['**/.goalie/*.{yaml,jsonl}'],
            debounceDelay: 100,
            recursive: true,
            trackMetadata: true,
    ...
    test('should handle file metadata correctly', () => {
        ...
        expect(metadata).toBeDefined();
        expect(metadata === null || metadata === void 0 ? void 0 : metadata.path).toBe(testFile);
        expect(metadata === null || metadata === void 0 ? void 0 : metadata.size).toBe(content.length);
        expect(metadata === null || metadata === void 0 ? void 0 : metadata.mtime).toBeInstanceOf(Date);
    });
    ...
    test('should add and remove patterns dynamically', () => {
        ...
        fileWatcherService.dispose();
        const newService = new fileWatcherService_1.FileWatcherService(testDir, {
...
//# sourceMappingURL=enhancedFileWatcher.test.js.map