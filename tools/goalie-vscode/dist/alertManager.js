...
class AlertManager {
    ...
    loadConfiguration() {
        ...
        if (config.has('globalSettings')) {
            this.configuration.globalSettings = Object.assign(Object.assign({}, this.configuration.globalSettings), config.get('globalSettings', {}));
        }
    }
    /**
    ...
    updateConfiguration(newConfig) {
        this.configuration = Object.assign(Object.assign({}, this.configuration), newConfig);
