...
// Stub types for external dependencies to avoid rootDir issues
export interface WSJFResult { [key: string]: any; }
export interface BatchRecommendation { [key: string]: any; }
export interface RiskAssessment { [key: string]: any; }
export interface AnalyticsSummary { [key: string]: any; }
export interface BatchExecutionPlan { [key: string]: any; }
export interface BatchExecutionResult { [key: string]: any; }
